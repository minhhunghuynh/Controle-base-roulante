...
void enc_config(void) {
    ...
    //_QEA2R = 7;               // CHA assignment to its RP12 pin
    //_QEB2R = 14;               // CHBA assignment to its RP15 pin (Comprend pas l'utilité)
...
void setup_PWM(void){
    ...
    PR2 = 1199; // car PR2 = FCY*PER - 1 (moins car commence à 0?)
