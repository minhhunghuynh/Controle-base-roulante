...
float enc_getPos1(int16_t dist_r1) {
    float pos_inter = (float) POS1CNT;
    float dist_inter = (float) dist_r1;
	return (10000*pos_inter/dist_inter);
}

float enc_getPos2(int16_t dist_r2) {
    float pos_inter = (float) POS2CNT;
    float dist_inter = (float) dist_r2;
	return (10000*pos_inter/dist_inter);
}
