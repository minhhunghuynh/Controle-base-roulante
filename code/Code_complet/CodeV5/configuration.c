 ...
 * We obtain Fosc = 7.37MHz*65/(3*2) = 79.96MHz */
...
/* Configures PLL prescaler, PLL postscaler, PLL divisor to obtain Fosc = 80MHz
 * with the EC oscillator on MC802 module (Fin = 12MHz). 
 * We obtain Fosc = 12MHz*40/(3*2) = 79.96MHz */
void extClockConfig(void) {
	...
	// Initiate Clock Switch to EC with PLL
